...
// import { ItemPriceEntity } from '../../item-prices/entities/item-price.entity';
...
export class ItemEntity {
	...
	// @OneToMany(() => ItemPriceEntity, (itemPrice) => itemPrice.item)
	// itemPrice: ItemPriceEntity[];
	
	@OneToMany(() => OrderEntity, (order) => order.item)
	itemPriceOrder: OrderEntity[];
}
